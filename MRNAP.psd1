...
@{
    ...
    Description       = 'Mold Report Name And Path.'
    ...
    FunctionsToExport = 'MRNAP', 'MoldReportNameAndPath', 'Join-AnyPath'
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            Tags       = @('Powershell', 'Filename', 'time', 'logging'.'date')
